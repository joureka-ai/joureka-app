...
const RecordingOverviewBar = ({recording}) => {
  ...
  return (
    <div className={`${recordingBar} ${ recording.words ? success : inactive}`}>
      ...
      <div className="d-flex ali">
        ...
        <button disabled={!recording.words} className="custom-button custom-button-sm custom-button-orange">Zum Projekt</button>
        </Link>
      </div>  
